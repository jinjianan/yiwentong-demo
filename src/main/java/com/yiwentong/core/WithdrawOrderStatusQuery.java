 ...
 * 提现订单查询
 */
public class WithdrawOrderStatusQuery {
    ...
    public static void main(String[] args) throws IOException{
        ...
        String token = TokenCore.getToken(
                ...
                TokenType.WITHDRAW_STATUS_CHECK);

        //构建签名参数
        WithdrawStatusCheckRequestDTO requestDTO = new WithdrawStatusCheckRequestDTO();
        ...
        String url = ServiceProviderConfig.URL+"payment/withdrawStatus";
        ...
        BaseResponse<WithdrawStatusCheckResponseDTO> baseResponse = null;
        WithdrawStatusCheckResponseDTO responseDTO = null;
        if (response.isSuccessful()) {
            baseResponse = DataParseUtil.getObj(tokenJsonRsp,new TypeReference<BaseResponse<WithdrawStatusCheckResponseDTO>>(){});
